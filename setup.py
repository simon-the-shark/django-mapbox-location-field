...
setup(
    ...
    download_url="https://github.com/kuyesu/django-mapbox-location-field/archive/v1.7.3.tar.gz",
    url='https://github.com/kuyesu/django-mapbox-location-field',
    author='kuyesu',
    author_email='2019bce028@std.must.ac.ug',
